...
import type { Node, Edge, Path, Rectangle, EventHandlers,  Nodes,  Edges,  InputPaths,  Layouts } from '../common/types';
...
declare const _sfc_main: DefineComponent<{
    ...
    hasEdgeLabelSlot: ComputedRef<boolean>;
    hasEdgesLabelSlot: ComputedRef<boolean>;
